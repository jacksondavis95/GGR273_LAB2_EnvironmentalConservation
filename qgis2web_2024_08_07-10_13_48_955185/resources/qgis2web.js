...
map.getView().fit([-15342979.359361, 5133887.876073, -8726784.075400, 9058313.774812], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Alberta Fish Stocking Points 2024</h2>';
        return titleElement;
    })(),
